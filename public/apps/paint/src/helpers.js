...
const $G = $(window);
// Marker used to identify content copied from JPPaint (internal content).
// This allows us to restrict pasting to only internal content in JP-OS.
export const JP_OS_INTERNAL_MARKER = "JP-OS-INTERNAL-CLIPBOARD-MARKER";
