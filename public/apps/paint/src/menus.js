...
/**
 * JP-OS / JPPaint Customizations:
 * 1. File Uploads: Disabled.
 * 2. External Pasting: Blocked (requires internal marker).
 * 3. Menus: Hidden in the UI by JP-OS (MenuBar component not rendered).
 * 
 * Context: JP-OS does not support file uploads and requires strict control over external image entry.
 */
